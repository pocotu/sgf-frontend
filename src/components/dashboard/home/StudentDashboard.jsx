      ...
      <div className="bg-primary-700 text-white rounded-2xl p-6 md:p-10 relative overflow-hidden shadow-lg">
        ...
        <div className="relative z-10">
          ...
          <p className="text-primary-100 text-lg mb-6">
            ¿Listo para seguir aprendiendo? Tienes 2 actividades pendientes hoy.
          </p>
          <div className="flex gap-3">
            <Button
              onClick={() => navigate('/dashboard/mis-notas')}
              className="bg-white text-primary-700 border-none hover:bg-primary-50"
            >
              Ver mis Notas
            </Button>
            <Button
              variant="outline"
              onClick={() => navigate('/dashboard/mis-asistencias')}
