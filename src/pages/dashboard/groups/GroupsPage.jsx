              ...
              <Card className="hover:border-primary-300 transition-colors h-full">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-sm text-slate-500">{group.modalidad} • Área {group.area}</p>
                  </div>
                ...
                <div className="space-y-2 text-sm text-slate-600 mb-4">
                  <div className="flex items-center gap-2">
                    <span>🕒</span>
                    <span>{group.dias} | {group.hora_inicio} - {group.hora_fin}</span>
                  </div>
                  <div className="flex items-center gap-2">
                     <span>👥</span>
                     <span>{group.estudiantes_matriculados} / {group.capacidad} estudiantes</span>
                  </div>
                </div>
                ...
                <div className="w-full bg-slate-100 rounded-full h-2 overflow-hidden">
                   <div 
                     ...
                     style={{ width: `${(group.estudiantes_matriculados / group.capacidad) * 100}%` }}
                   ></div>
                </div>
