      ...
      <div className="space-y-4">
        ...
        <div className="border rounded-md max-h-60 overflow-y-auto">
            {filteredStudents.length === 0 ? (
                <div className="p-4 text-center text-slate-500 text-sm">No se encontraron estudiantes</div>
            ) : (
                    ...
                    >
                        <div className="flex items-center gap-3 w-full">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-400">{student.dni} • {student.modalidad}</p>
                            </div>
                        </div>
                    </div>
                ))
